...
@Component({
  selector: 'app-detail-penerimaan-gudang',
  templateUrl: './detail-penerimaan-gudang.component.html',
  styleUrl: './detail-penerimaan-gudang.component.scss',
})
export class DetailPenerimaanGudangComponent
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        ...
        setTimeout(() => {
          this.dataService
            .postData(
              `${this.config.BASE_URL}/api/penerimaan-gudang/detail`,
              request
            )
            .subscribe((resp: any) => {
