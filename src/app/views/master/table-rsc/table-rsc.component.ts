...
@Component({
  selector: 'app-table-rsc',
  templateUrl: './table-rsc.component.html',
  styleUrl: './table-rsc.component.scss',
})
export class TableRscComponent implements OnInit, OnDestroy, AfterViewInit {
  columns: any;
  page = new Page();
  data: any;
