...
export class TableAreaComponent implements OnInit, OnDestroy, AfterViewInit {
  columns: any;
  page = new Page();
  data: any;
  ...
  constructor(
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback:any) => {
        ...
        this.dataService
          .postData(this.g.urlServer + '/api/area/dt', dataTablesParameters)
          .subscribe((resp: any) => {
