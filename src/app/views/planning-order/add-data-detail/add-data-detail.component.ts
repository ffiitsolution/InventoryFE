  ...
  implements OnInit, OnDestroy, AfterViewInit
{
  ...
  onInputValueItemDetail(event: any, index: number, type: number = 1) {
  ...
  get filteredData() {
    ...
    return filtered.sort((a, b) => a.kodeBarang?.localeCompare(b.kodeBarang));
  }
