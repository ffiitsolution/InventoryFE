...
export { SendOrderToWarehouseAddComponent } from './add/add.component';
export { AddDataDetailSendOrderToWarehouseComponent } from './add-data-detail/add-data-detail.component';
export { DetailSendOrderToWarehouseComponent } from './detail/detail.component';
