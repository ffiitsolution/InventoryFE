...
import { AddDataSendOrderToSupplierComponent } from './add-data.component';
...
describe('DeliveryItemAddComponent', () => {
  let component: AddDataSendOrderToSupplierComponent;
  let fixture: ComponentFixture<AddDataSendOrderToSupplierComponent>;
  let dataService: DataService;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [AddDataSendOrderToSupplierComponent],
      imports: [
        FormsModule,
        RouterTestingModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddDataSendOrderToSupplierComponent);
