...
@Component({
  selector: 'app-add-data-detail-order-manual',
  templateUrl: './add-data-detail.component.html',
  styleUrl: './add-data-detail.component.scss',
})
export class AddDataDetailOrderManualComponent
  ...
  onShowModalOnSubmit() {
       Swal.fire({
          title: '<div style="color: white; background: #c0392b; padding: 12px 20px; font-size: 18px;">Konfirmasi Proses Simpan Data</div>',
          html: `
