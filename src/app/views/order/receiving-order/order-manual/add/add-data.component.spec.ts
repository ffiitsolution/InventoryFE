...
import { AddDataOrderManualComponent } from './add-data.component';
...
describe('DeliveryItemAddComponent', () => {
  let component: AddDataOrderManualComponent;
  let fixture: ComponentFixture<AddDataOrderManualComponent>;
  let dataService: DataService;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [AddDataOrderManualComponent],
      imports: [
        FormsModule,
        RouterTestingModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddDataOrderManualComponent);
