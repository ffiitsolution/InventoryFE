...
@Component({
  selector: 'app-print-button-growth',
  templateUrl: './print-btn-growth.component.html',
  styleUrls: ['./print-btn-growth.component.scss']
})
export class PrintButtonGrowthSharedComponent {
